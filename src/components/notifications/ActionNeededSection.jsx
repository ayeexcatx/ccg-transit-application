      ...
      <Card className={homeSectionCardClass}>
        ...
        <div className="border-b border-red-100 bg-red-50/40 px-4 py-2.5">
          <p className="text-xs leading-relaxed text-slate-600">
            This section shows opportunities that need your attention right away, such as opportunities waiting for your
            acceptance. An opportunity will remain here until you open it and click Accept.
          </p>
        </div>
