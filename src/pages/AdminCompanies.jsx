...
export default function AdminCompanies() {
  ...
  const [form, setForm] = useState({ name: '', address: '', additional_contact_name: '', contact_methods: [{ type: 'Office', value: '' }], trucks: [], status: 'active' });
  ...
  const openNew = () => {
    setEditing(null);
    setForm({ name: '', address: '', additional_contact_name: '', contact_methods: [{ type: 'Office', value: '' }], trucks: [], status: 'active' });
    setTruckInput('');
    setOpen(true);
  };
