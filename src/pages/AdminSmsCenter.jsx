    ...
    const catalog = [
      ...
      createTemplatePreview({
        ...
        body: [
          ...
          dispatchLine,
          '',
          'Please open app to view and ACCEPT.',
        ].join('\n'),
      ...
      createTemplatePreview({
        ...
        body: [
          'CCG Transit: CANCELLED',
          'Your assignment has been canceled.',
          dispatchLine,
          '',
          'Please open the app to view and ACCEPT.',
        ].join('\n'),
      ...
      createTemplatePreview({
        group: 'Driver',
        title: 'Driver new assignment SMS',
        body: `CCG Transit: NEW\nYou have received a new assignment.\n${dispatchLine}\n\nPlease open the app to view.`,
        description: 'Driver assignment notification SMS format.',
      }),
      createTemplatePreview({
        group: 'Driver',
        title: 'Driver assignment amended SMS',
        body: `CCG Transit: AMENDED\nYour assignment has been amended.\n${dispatchLine}\n\nPlease open the app to view.`,
        description: 'Driver amended assignment SMS format.',
      }),
      createTemplatePreview({
        group: 'Driver',
        title: 'Driver assignment cancelled SMS',
        body: `CCG Transit: CANCELLED\nYour assignment has been canceled.\n${dispatchLine}\n\nPlease open the app to view.`,
        description: 'Driver cancelled assignment SMS format.',
      }),
      createTemplatePreview({
        group: 'Driver',
        title: 'Driver assignment removed SMS',
      ...
      createTemplatePreview({
        ...
        body: `CCG Transit: Acme Hauling has accepted the assignment.\nTUE 04-14-2026 at 7:00 AM\nJOB-1042 | TRK-12, TRK-44\n\nPlease open the app to view.`,
