...
## Present but insufficiently covered (resolved by this audit and April 2026 baseline cleanup)
1. Global app shell/header behavior (persistent header, role/workspace identity line, header actions, admin nav set including SMS Center and Driver Protocol) was only implicit and not clearly captured as a baseline preservation rule.
